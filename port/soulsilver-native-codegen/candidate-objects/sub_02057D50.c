...
extern unsigned char ssdata_unk_02056D7C__021D41C4[];
uint32_t native_sub_02057D50(uint32_t a0,uint32_t a1,uint32_t a2,uint32_t a3) {
...
x=r2; y=3; res=x-y;
sf(&f,x,y,res);
if (!f.z) goto _02057D64;
r1=(uint32_t)(uintptr_t)ssdata_unk_02056D7C__021D41C4;
r2=0;
nz(&f,r2);
r1=ld32(r1);
x=r1; y=r0; res=x+y;
