...
extern unsigned char ssdata_unk_02032844__021D4124[];
uint32_t native_sub_02033250(uint32_t a0,uint32_t a1,uint32_t a2,uint32_t a3) {
...
r0=(uint32_t)(uintptr_t)ssdata_unk_02032844__021D4124;
r1=ld32(r0 + 4);
r0=0x0000132E;
r0=ld16(r1 + r0);
return r0;
