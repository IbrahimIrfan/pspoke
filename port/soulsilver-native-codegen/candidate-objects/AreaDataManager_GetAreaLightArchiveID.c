...
uint32_t native_AreaDataManager_GetAreaLightArchiveID(uint32_t a0,uint32_t a1,uint32_t a2,uint32_t a3) {
...
x=r0; y=0; res=x-y;
sf(&f,x,y,res);
if (f.z) goto _021FBA26;
x=r0; y=1; res=x-y;
sf(&f,x,y,res);
if (f.z) goto _021FBA2A;
x=r0; y=2; res=x-y;
sf(&f,x,y,res);
if (f.z) goto _021FBA2E;
if (1) goto _021FBA32;
_021FBA26:
r0=1;
nz(&f,r0);
