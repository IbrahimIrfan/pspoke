...
extern unsigned char sub_02038854[];
uint32_t native_sub_02037FCC(uint32_t a0,uint32_t a1,uint32_t a2,uint32_t a3) {
...
x=r0; y=0; res=x-y;
sf(&f,x,y,res);
if (!f.z) goto _02037FD8;
r0=0;
nz(&f,r0);
return r0;
_02037FD8:
r1=ld32(r0 + 0x24);
r0=(uint32_t)(uintptr_t)sub_02038854;
x=r1; y=r0; res=x-y;
sf(&f,x,y,res);
if (!f.z) goto _02037FE4;
r0=1;
nz(&f,r0);
return r0;
_02037FE4:
