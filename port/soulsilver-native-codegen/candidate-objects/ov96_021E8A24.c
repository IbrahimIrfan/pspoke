...
extern unsigned char ssdata_overlay_96_ov96_0221AEC4[];
uint32_t native_ov96_021E8A24(uint32_t a0,uint32_t a1,uint32_t a2,uint32_t a3) {
...
r0=(uint32_t)(uintptr_t)ssdata_overlay_96_ov96_0221AEC4;
return r0;
}
