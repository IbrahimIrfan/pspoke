...
extern unsigned char ssdata_unk_02058034__021D41C8[];
extern unsigned char sub_02058608[];
extern unsigned char sub_020586EC[];
uint32_t native_sub_02058740(uint32_t a0,uint32_t a1,uint32_t a2,uint32_t a3) {
...
r0=(uint32_t)(uintptr_t)ssdata_unk_02058034__021D41C8;
r0=ld32(r0);
x=r0; y=0; res=x-y;
sf(&f,x,y,res);
if (f.z) goto _0205875A;
r1=ld32(r0 + 0x30);
r0=(uint32_t)(uintptr_t)sub_020586EC;
x=r1; y=r0; res=x-y;
sf(&f,x,y,res);
if (f.z) goto _02058756;
r0=(uint32_t)(uintptr_t)sub_02058608;
x=r1; y=r0; res=x-y;
sf(&f,x,y,res);
if (!f.z) goto _0205875A;
_02058756:
