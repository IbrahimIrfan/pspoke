...
uint32_t native_sub_0203401C(uint32_t a0,uint32_t a1,uint32_t a2,uint32_t a3) {
...
x=r0; y=0x12; res=x-y;
sf(&f,x,y,res);
if (!f.z&&f.n==f.v) goto _02034036;
if (f.n==f.v) goto _0203403A;
x=r0; y=0xd; res=x-y;
sf(&f,x,y,res);
if (!f.z&&f.n==f.v) goto _0203403E;
x=r0; y=7; res=x-y;
sf(&f,x,y,res);
if (f.n!=f.v) goto _0203403E;
if (f.z) goto _0203403A;
x=r0; y=9; res=x-y;
sf(&f,x,y,res);
if (f.z) goto _0203403A;
x=r0; y=0xd; res=x-y;
