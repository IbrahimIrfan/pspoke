...
extern unsigned char sub_02038E90[];
extern unsigned char sub_02038E94[];
extern unsigned char sub_02039E7C[];
uint32_t native_sub_020393C8(uint32_t a0,uint32_t a1,uint32_t a2,uint32_t a3) {
...
x=r2; y=0; res=x-y;
sf(&f,x,y,res);
if (f.z) goto _02039402;
r1=ld32(r2 + 0x24);
r0=(uint32_t)(uintptr_t)sub_02038E90;
x=r1; y=r0; res=x-y;
sf(&f,x,y,res);
if (!f.z) goto _020393DC;
r0=1;
nz(&f,r0);
return r0;
_020393DC:
r0=(uint32_t)(uintptr_t)sub_02038E94;
x=r1; y=r0; res=x-y;
sf(&f,x,y,res);
if (!f.z) goto _020393F0;
x=r2; y=0; res=x+y;
r0=res;
af(&f,x,y,res);
x=r0; y=0x53; res=x+y;
...
return r0;
_020393F0:
r0=(uint32_t)(uintptr_t)sub_02039E7C;
x=r1; y=r0; res=x-y;
sf(&f,x,y,res);
if (!f.z) goto _02039402;
x=r2; y=0x53; res=x+y;
