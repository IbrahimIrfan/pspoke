...
extern unsigned char ssdata_overlay_00_thumb__0221A680[];
uint32_t native_ov00_021E7130(uint32_t a0,uint32_t a1,uint32_t a2,uint32_t a3) {
...
r0=(uint32_t)(uintptr_t)ssdata_overlay_00_thumb__0221A680;
r2=0;
nz(&f,r2);
r1=ld32(r0);
r0=0x000010E0;
