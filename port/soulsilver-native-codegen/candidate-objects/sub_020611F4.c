...
extern unsigned char ssdata_unk_0205FD20__020FD4DC[];
uint32_t native_sub_020611F4(uint32_t a0,uint32_t a1,uint32_t a2,uint32_t a3) {
...
r1=shift(&f,r0,2);
r0=(uint32_t)(uintptr_t)ssdata_unk_0205FD20__020FD4DC;
r0=ld32(r0 + r1);
return r0;
}
