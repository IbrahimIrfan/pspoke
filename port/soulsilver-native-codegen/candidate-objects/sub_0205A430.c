...
extern unsigned char ssdata_unk_02058AEC__021D41CC[];
uint32_t native_sub_0205A430(uint32_t a0,uint32_t a1,uint32_t a2,uint32_t a3) {
...
x=r0; y=0; res=x-y;
sf(&f,x,y,res);
if (!f.z) goto _0205A444;
r0=ld8(r2);
st32(r1 + 0x30,r0);
r1=ld8(r2);
r0=(uint32_t)(uintptr_t)ssdata_unk_02058AEC__021D41CC;
st32(r0 + 8,r1);
_0205A444:
return r0;
}
