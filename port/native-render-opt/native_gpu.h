...
namespace GPU3D {struct R {bool Accelerated=false;};extern R*CurrentRenderer;extern u32 RenderXPos;inline void SetRenderXPos(u32 x){RenderXPos=x;}extern u32 NativeFrame[256*192];u32*GetLine(unsigned);}
