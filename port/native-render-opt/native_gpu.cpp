...
namespace GPU3D {R renderer;R*CurrentRenderer=&renderer;u32 RenderXPos;alignas(16) u32 NativeFrame[256*192]={};u32*GetLine(unsigned n){return NativeFrame+(n%192)*256;}}
namespace GPU2D {
Unit::Unit(u32 num)
{
    Num = num;
