...
#endif
{
    ...
    if (JOY_NEW(PAD_BUTTON_A)) {
        printf("[CHOICE] frame=%u cursor=%u value=%llx\n",PSPNativeRenderFrameCount(),menu->cursorPos,(unsigned long long)menu->template.choices[menu->cursorPos].callbackFunction);
